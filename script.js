...
function show() {
    ...
    for (i = 0; i < posts.length; i++) {
        ...
        content.innerHTML += generatePostHTML(post, i);
...
function generatePostHTML(post, index) {
    ...
    const likeImage = post.liked ? "./img/heartred.png" : "./img/herz.png";
        ...
        <div class="postcontent">
            ...
            <div class="reaction">
                <div class="underImgIcon">
                    <img onclick="like(${index})" id="like${index}" class="marker" src="${likeImage}" alt="">
                    <img onclick="demoAlert()" class="marker" src="./img/papierflieger.png" alt="">
                    <img onclick="demoAlert()" class="marker" src="./img/kommentar.png" alt="">
                </div>
                <div onclick="demoAlert()"><img class="marker" src="./img/lesezeichen.png" alt=""></div>
            </div>
            <div class="showLikes"><b>Gefällt <span id="showLikes${index}">${post['likes']}</span></b></div>
            <div class="description">${post['description']}</div>
            <div id="comments"><b>${post['author']} :</b> ${post['comments']}</div>
            <div class="shownewcomment" id="shownewcomment${index}"></div>
            <div class="commentsection">
                <textarea class="addnewcomment" name="" id="addnewcomment${index}" cols="50" rows="2" placeholder="Kommentieren..."></textarea>
                <button onclick="addComment(${index})" id="addComment">Posten</button>
            </div>
        </div>`;
}
